...
export const ValueCards = () => {
  ...
  return (
    <div className='v-cards-wrap' ref={cardsRef}>
      <ValueCard title="Target Audience" img="../../../../public/targeticon.svg" hoverIcon="../../../../public/targeticon2.svg" text="People who are unbanked or underbanked, a design system that helps you to improve your financial idea"></ValueCard>
      ...
      <ValueCard title="Personality" img="../../../../public/personalityicon.svg" hoverIcon="../../../../public/personalityicon2.svg" text="Friendly finance assistant, ideal if your looking more than the usual components"></ValueCard>
